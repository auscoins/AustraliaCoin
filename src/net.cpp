...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "AUSCoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"auscointools.com", "120.145.186.199"},
    {"auscoinpool.org", "162.250.125.26"}
};

static const char *strTestNetDNSSeed[][2] = {
    {"auscointools.com", "testnet-seed.auscointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. AUSCoin is probably already running."), addrBind.ToString().c_str());
        else
